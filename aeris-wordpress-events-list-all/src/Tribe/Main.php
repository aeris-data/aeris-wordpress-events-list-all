...
if ( ! class_exists( 'Tribe__Events__Main' ) ) {
	...
	class Tribe__Events__Main {
		...
		/**
		 * Set all events to Tribe
		 * 
		 * @param array $list
		 */
		public static function setEventsList($list) {
			
			$tribe = self::instance();
			$tribe->allEvents = $list;
		}
		
		/**
		 * Get all events to Tribe
		 *
		 * @param array $list
		 */
		public static function getEventsList() {
			$tribe = self::instance();
			return $tribe->allEvents;
		}
		...
		protected function loadLibraries() {
			...
			require_once $this->plugin_path . 'common/src/Tribe/Date_Utils.php';
			...
			require_once $this->plugin_path . 'src/views/widgets/aeris-events-calendar.php';
		...
		final public static function getInstance()
		{
			if ( ! isset(self::$instance)) {
				$class = new Tribe__Events__Main(__CLASS__);
		...
		public function init() {
			...
			$this->upcomingSlug                               = sanitize_title( __( 'meetings', 'the-events-calendar' ) );
