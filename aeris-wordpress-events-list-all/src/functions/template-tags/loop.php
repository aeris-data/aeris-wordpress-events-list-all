...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	 ...
	 * @param object event
	 **/
	function tribe_events_set_the_date_header($event) {
		...
		$html = '';
			...
			$event_year        = tribe_get_start_date( $event, false, 'Y' );
			$event_month       = tribe_get_start_date( $event, false, 'm' );
			 ...
			 *
			 */
				$html .= sprintf( "<span class='tribe-events-list-separator-month'><span>%s</span></span>", tribe_get_start_date( $event, false, $month_year_format ) );
			
			
			echo apply_filters( 'tribe_events_set_the_date_header', $html, $event_month, $event_year );
