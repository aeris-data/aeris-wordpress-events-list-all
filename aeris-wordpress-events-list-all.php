...
// require_once dirname( __FILE__ ) . '/common/src/functions/template-tags/general.php';

// require_once dirname( __FILE__ ) . '/src/Tribe/Query.php';
// require_once dirname( __FILE__ ) . '/common/src/Tribe/Cache.php';

// require_once dirname( __FILE__ ) . '/common/src/Tribe/Main.php';

// require_once dirname( __FILE__ ) . '/common/src/Tribe/Settings_Manager.php';
